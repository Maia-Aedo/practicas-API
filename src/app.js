...
// FRAMEWORK simplifica creacion de api
const morgan = require('morgan'); 
// MIDDLEWARE registra info de solicitudes HTTP en consola
const cors = require('cors'); 
// MIDDLEWARE los servidores pueden especificar el acceso permitido a recursos
...
//definimos nuestras routes con GET en la url raiz
app.get('/', (req, res) => {
    // devuelve obj json con msj de bienvenida
    res.status(200).json({
        ok: true,
...
// obtener lista de usuarios en la ruta /users
...
app.get('/user/find', (req, res) => {
    ...
    // ambos obj en la misma sentencia, ++especifico
